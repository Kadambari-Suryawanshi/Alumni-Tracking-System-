            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="card" onclick="location.href='alumniwnj.php';">
                                <div class="card-body bg-primary">
                                    <div class="card-body text-white">
                                        <span class="float-right summary_icon"><i class="fa fa-users"></i></span>
                                        <h4><b>
                                            <?php echo $conn->query("SELECT * FROM alumnus_bio where connected_to='No Job'")->num_rows; ?>
                                        </b></h4>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="card" onclick="location.href='alumniwj.php';">
                                <div class="card-body bg-primary">
                                    <div class="card-body text-white">
                                        <span class="float-right summary_icon"><i class="fa fa-users"></i></span>
                                        <h4><b>
                                            <?php echo $conn->query("SELECT * FROM alumnus_bio a JOIN courses c ON a.course_id= c.id where a.connected_to !='No Job'")->num_rows; ?>
                                        </b></h4>
                                        <p><b> Alumni With Job
