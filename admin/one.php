				...
				<div class="card">
								...
								<form action="" method="GET">
									<div class="row">
										...
										<select name="course" required class="form-select">
											...
											<option value="Computer Engineering" <?= isset($_GET['course']) == true ? ($_GET['course'] =='Computer Engineering' ? 'selected':''):'' ?>>Computer Engineering</option>
											<option value=" Mechanical Engineering" <?= isset($_GET['course']) == true ? ($_GET['course'] =='Mechanical Engineering' ? 'selected':''):'' ?>> Mechanical Engineering</option>
											<option value="Electrical Engineering" <?= isset($_GET['course']) == true ? ($_GET['course'] =='Electrical Engineering' ? 'selected':''):'' ?>>Electrical Engineering</option>
											<option value="Civil Engineering" <?= isset($_GET['course']) == true ? ($_GET['course'] =='Civil Engineering'? 'selected':''):'' ?>>Civil Engineering</option>
											</select>
										</div>
										<div class="col-md-4">
											<select name="batch" required class="form-select">
											<option value="">Select Batch</option>
											<option value="2023" <?= isset($_GET['batch']) == true ? ($_GET['batch'] =='2023' ? 'selected':''):'' ?>>2023</option>
											<option value="2024" <?= isset($_GET['batch']) == true ? ($_GET['batch'] =='2024' ? 'selected':''):'' ?>>2024</option>
											<option value="2025" <?= isset($_GET['batch']) == true ? ($_GET['batch'] =='2025' ? 'selected':''):'' ?>>2025</option>
											</select>
										</div>
										<div class="col-md-4">
					...
					<div class="card-body">
						<table class="table table-condensed table-bordered table-hover">
							...
							<tbody>
								<?php
								if(isset($_GET['course']) && $_GET['course'] != '' && isset($_GET['batch']) && $_GET['batch'] != ''){
